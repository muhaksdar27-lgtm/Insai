...
export class MarketScanner {
  ...
  public async scan() {
    ...
    healthCheckEngine.updateServiceHealth('RuleEngine', 'SCAN_IN_PROGRESS', 0, 'Scan in progress');
    ...
    try {
      ...
      healthCheckEngine.updateServiceHealth('RuleEngine', 'ONLINE', Date.now() - startTime, 'Scan completed');
